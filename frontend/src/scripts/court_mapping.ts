export interface CourtGeo {
  parent_court?: string;
  county: string;
  district: string | null;
}

export const SIMPLE_COURT_MAPPING: Record<string, CourtGeo> = {
  "三重簡易庭": {
...
export const DISTRICT_COURT_MAPPING: Record<string, CourtGeo> = {
...
export const HAC_COUNTY_MAPPING: Record<string, CourtGeo> = {
